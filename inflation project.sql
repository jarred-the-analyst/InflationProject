...
1. how is inflation effecting the majority of americans? 
To assess how inflation is impacting the majority of Americans, the first step is to analyze their primary expenses.
By examining the most significant expenditure categories, we can gain insights into how the majority of Americans are 
affected. According to the U.S. Bureau of Labor Statistics, the top four expenditures for Americans are housing, transportation, 
food, and healthcare. To understand the specific impact on the majority of Americans, I will calculate the inflation rates for these 
four categories. Additionally, I will separate rent and homeownership costs, resulting in a total of five calculations. To evaluate inflation 
trends in the housing market, I will utilize the average median price for the home calculation. By conducting these analyses, we can gain a better 
understanding of how inflation influences the key expenses that significantly impact the majority of Americans.
...
/* 	sample of data:
    ...
    sometimes vastly different. to address the first two questions though,I will need to calculate the average inflation rate for each of the four categories. 
    This will enable me to assess the overall inflation effects on Americans for these specific expenditure categories and identify any notable distinctions between them and the CPI.
*/ 
...
americans feels alot of inflationary pressure towards housing and rent. this can be said the same with health care
which is another major expense. on the other hand even though trasportation and food are rising faster than the cpi
it is not increasing faster than wages making it less of a worry for the avarage american.

2.out of the four categories housing and healthcare were the two catagories that were significantly higher than the cpi.
transportation and food was higher than the cpi also but not by much.so, expense toward homeowners and renters typically goes up more than the cpi. 
 
*/
-- using two cte to have the data next to each other so its easeir to look at
with y_96 as (
select
	years,
    cpi, 
...
year cpi_96_08			Year_from_96_08	 	year               		cpi_09_21	 		   		Year_from_09_21
...
3.Upon examining the data for the first 12 years (1996-2008), it is evident that the inflation rate for homes experienced a significant increase. The peak occurred in 2003, 
...
for people who are poor or in the middle class. To tackle this issue, one suggestion is for the government to provide subsidies to companies that pay their 
employees higher wages. This would encourage companies to pay better wages and help improve the financial situation of workers.
In general, inflation is a big concern for most Americans and needs the full attention of both the Federal Reserve and the government to keep it under control. 
It's important to take necessary actions to make housing more affordable, address the lack of wage growth, and implement policies that promote economic stability and fairness.


additonaly, consumers can now have better understanting of what parts of their budget they need to plan for the long run.
knowing on avarage housing prices and healthcare have been signifcantly incearsing faster than wages I would advise
people to find jobs that have great healthcare benfits so that, that expense would be less of a burden. also
